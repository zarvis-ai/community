...
latex_documents = [
    (master_doc, 'ZARVIS.tex', u'ZARVIS Documentation',
     u'Edwin Zarvis', 'manual'),
]
...
man_pages = [
    (master_doc, 'zarvis', u'ZARVIS Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'ZARVIS', u'ZARVIS Documentation',
     author, 'ZARVIS', 'One line description of project.',
     'Miscellaneous'),
]
